...
import newImages from "../../assets/projects_2025-26/index";

export const projectCarousel = {
  data: [
    <Image
      simple_image={ImagesReduced.BeachReduced}
      HD_image={Images.Beach}
      alt={"beach"}
    />,
    <Image
      simple_image={ImagesReduced.NPaperReduced}
      HD_image={Images.Newspaper}
      alt={"newspaper"}
    />,
    <Image
      simple_image={ImagesReduced.GaneshReduced}
      HD_image={Images.Ganesh}
      alt={"ganesh"}
    />,
    <Image
      simple_image={ImagesReduced.NashaReduced}
      HD_image={Images.Nasha_mukti}
      alt={"nasha_mukti"}
    />,
    <Image
      simple_image={ImagesReduced.HealthReduced}
      HD_image={Images.Online_health}
      alt={"online_health"}
    />,
    <Image
      simple_image={ImagesReduced.BloodReduced}
      HD_image={Images.Blood}
      alt={"blood"}
    />,
  ],
};
...
export const major_projects = [
  {
    ...
    images: [...Images.PachPran],
    reduced_images: [...ImagesReduced.PachPran],
    domain: "EDUCATION",
  ...
  },
  {
    ...
    domain: "HEALTH",
    images: [...Images.Nutrition],
    reduced_images: [...ImagesReduced.Nutrition],
  ...
  },
  {
    ...
    domain: "EDUCATION",
    images: [...Images.OrganDonation],
    reduced_images: [...ImagesReduced.OrganDonation],
  ...
  },
  {
    ...
    domain: "ENVIRONMENT",
    images: [...Images.BeachCleanUp],
    reduced_images: [...ImagesReduced.BeachCleanUp],
  ...
  },
  {
    ...
    domain: "HEALTH",
    images: [...Images.BoosterDose],
    reduced_images: [...ImagesReduced.BoosterDose],
  ...
  },
  {
    ...
    domain: "HEALTH",
    images: [...Images.MedicalCamp],
    reduced_images: [...ImagesReduced.MedicalCamp],
  ...
  },
  {
    ...
    domain: "SOCIETY",
    images: [...Images.Tiringa],
    reduced_images: [...ImagesReduced.Tiringa],
  ...
  },
  {
    ...
    reduced_images: [...ImagesReduced.Selfie],
  ...
  },
  {
    ...
    domain: "SOCIETY, CAMP",
    images: [...Images.TalkWithVillage],
    reduced_images: [...ImagesReduced.TalkWithVillage],
  ...
  },
  {
    ...
    project: "Kite Making",
    domain: "ENVIRONMENT",
    images: [...Images.KiteMaking],
    reduced_images: [...ImagesReduced.KiteMaking],
  ...
  },
  {
    ...
    domain: "SOCIETY",
    images: [...Images.AmritKalash],
    reduced_images: [...ImagesReduced.AmritKalash],
  ...
  },
  {
    ...
    domain: "SOCIETY",
    images: [...Images.TrafficManage],
    reduced_images: [...ImagesReduced.TrafficManage],
  ...
  },
  {
    ...
    domain: "SOCIETY, CAMP",
    images: [...Images.SaivanDonation],
    reduced_images: [...ImagesReduced.SaivanDonation],
  ...
  },
  {
    ...
    domain: "SOCIETY, CAMP",
    images: [...Images.JagruktaAbhi],
    reduced_images: [...ImagesReduced.JagruktaAbhi],
  ...
  },
  {
    ...
    domain: "SOCIETY",
    images: [...Images.MeriMati],
    reduced_images: [...ImagesReduced.MeriMati],
  ...
  },
  {
    ...
    domain: "SOCIETY, CAMP",
    images: [...Images.WallPainting],
    reduced_images: [...ImagesReduced.WallPainting],
  ...
  },
  {
    ...
    domain: "SOCIETY",
    images: [...Images.EnergyCons],
    reduced_images: [...ImagesReduced.EnergyCons],
  ...
  },
  {
    ...
    images: [...Images.SchoolTeaching],
    reduced_images: [...ImagesReduced.SchoolTeaching],
  ...
  },
  {
    ...
    domain: "EDUCATION, CAMP",
    images: [...Images.NukkadSamajik],
    reduced_images: [...ImagesReduced.NukkadSamajik],
  ...
  },
  {
    ...
    domain: "EDUCATION",
    images: [...Images.Cancer],
    reduced_images: [...ImagesReduced.Cancer],
  ...
  },
  {
    ...
    domain: "HEALTH, CAMP",
    images: [...Images.MenstCyc],
    reduced_images: [...ImagesReduced.MenstCyc],
  ...
  },
  {
    ...
    domain: "HEALTH, CAMP",
    images: [...Images.FreeMedical],
    reduced_images: [...ImagesReduced.FreeMedical],
  ...
  },
  {
    ...
    domain: "HEALTH, CAMP",
    images: [...Images.Stem],
    reduced_images: [...ImagesReduced.Stem],
...
export const minor_project = [
  ...
  {
    id: 214,
    image: Images.ElectricityConservation,
  ...
  },
  {
    ...
    image: Images.JagruktaAbhiPoster,
    domain: "EDUCATION, CAMP",
    quote:
...
export const domain_names = [
  { name: "All", search: "", icon: DomainLogos.Heart },
  { name: "Environment", search: "ENVIRONMENT", icon: DomainLogos.Earth },
  { name: "Education", search: "EDUCATION", icon: DomainLogos.Book },
  { name: "Society", search: "SOCIETY", icon: DomainLogos.UserGroup },
  { name: "Health", search: "HEALTH", icon: DomainLogos.HeartPulse },
  { name: "NSS Camp", search: "CAMP", icon: DomainLogos.CampFire },
];
